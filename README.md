...
|---|---|---|
| Kafka external listener | `localhost:9092` | Python producer on Windows |
| Kafka internal listener | `kafka:29092` | PyFlink inside Docker |
| Flink Dashboard | `http://localhost:8081` | Web browser |
...
Open the Flink Dashboard at [http://localhost:8081](http://localhost:8081). The job should appear under **Jobs > Running Jobs**.
...
2. Select the traffic-processing job.
3. Open **Overview**.
